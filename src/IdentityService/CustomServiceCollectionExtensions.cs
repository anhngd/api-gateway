...
using CorrelationId;
using IdentityService.OperationFilters;
...
namespace IdentityService
{
    ...
    public static class CustomServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddCustomDbContext(this IServiceCollection services)
        {
            ...
            //if (string.Compare(Configuration.GetValue<string>("DbEngine"), "SQLite", true) == 0)
            //{
            //    dbEngine = "SQLite";
            ...
            //services.AddDbContext<TDIdentityDbContext>(builder =>
            //{
            //    if (dbEngine == "SQLite")
            //    {
